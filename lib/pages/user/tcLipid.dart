              ...
              child: Column(
                children: <Widget>[
                   ...
                   LinearPercentIndicator(
                    ...
                    center: const Text('< 5.2',style: TextStyle(fontSize: 15),),
                    lineHeight: 20.0,
                    percent: 0.2,
                 ...
                 LinearPercentIndicator(
                    ...
                    center: const Text('> 5.20 && <= 6.2',style: TextStyle(fontSize: 15),),
                   width: 150.0,
                    lineHeight: 20.0,
                    percent: 0.5,
                   ...
                   LinearPercentIndicator(
                     center: const Text('> 6.2',style: TextStyle(fontSize: 15),),
                    width: 150.0,
                    lineHeight: 20.0,
                    percent: 0.9,
