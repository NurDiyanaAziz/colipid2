...
class hdlLipid extends StatefulWidget {
  //const AdminViewReportPatient({Key? key}) : super(key: key);
  // ignore: prefer_typing_uninitialized_variables
  var myObject;
  hdlLipid({super.key, this.myObject});
  @override
...
class _hdlLipidState extends State<hdlLipid> {
  late String tc;
  late String year;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          const Text("High Density Lipoprotein" + '\n(Good Cholesterol)',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 15.0,
          ...
          Center(
              child: Container(
                  child: SfCartesianChart(
                      ...
                      primaryYAxis:
                          NumericAxis(minimum: 0, maximum: 5, interval: 0.5),
                      tooltipBehavior: _tooltip,
